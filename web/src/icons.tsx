...
/// Feather icons (MIT), inlined. One SVG wrapper and a path table rather
/// than a file per glyph: at this size the wrapper is bigger than the
/// path, and a sprite sheet would be a build step for eleven shapes.
///
/// The three kind glyphs are shared by the library card's art corner and
/// the header's jump menu, which is why they live here rather than in
/// either one.
...
export default function Icon({
  ...
  return (
    <svg
      ...
      // Decorative unless it is the only thing naming its control, in
      // which case the caller passes a title and it becomes an image.
